$(function(){
    ...
    $('.main_container_menu ul li').click(function(){
        var tab_id = $(this).attr('data-tab');
        $('.main_container_menu ul li').removeClass('active');
        $(this).addClass('active');
        $('.main_container_content').removeClass('active');

        $("#"+tab_id).addClass('active');
    })
    $('.trainer_info').click(function() {
        var tab_id = $(this).attr('data-tab');
        $('.trainer_info_content').removeClass('active');
