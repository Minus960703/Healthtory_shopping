...
<body>
	...
	<section id="container">
		<form role="form" method="post" autocomplete="off"
			...
			<label>상품이름</label><input type="text" name="goodsName" id="goodsName" value="${goods.goodsName}" /><br /> 
			<label>상품가격</label> 
			...
			<label>상품 설명</label>
			<textarea id="summernote" name="goodsImage" class="editordata">${goods.goodsImage}</textarea>
			...
			<script>
				$("#back_Btn").click(function() {
					location.href = "/admin/goods/view?goodsNum=" + $
					{
						goods.goodsNum
					}
					;
